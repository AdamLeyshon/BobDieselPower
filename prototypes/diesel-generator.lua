  ...
  {
    {
      ...
      icon = "__TS_Power__/graphics/icons/petroleum-generator-icon.png",
      icon_size = 64,
      flags = {},
      subgroup = "energy",
    ...
    },
    {
      ...
      horizontal_animation =
      {
        layers = {
          {
            filename = "__TS_Power__/graphics/entity/petroleum-generator/hr-petroleum-generator-horizontal-base.png",
            width = 548,
            height = 256,
            frame_count = 1,
            repeat_count = 14,
          ...
          {
            filename =
            "__TS_Power__/graphics/entity/petroleum-generator/hr-petroleum-generator-horizontal-base-shadow.png",
            width = 548,
            height = 256,
            frame_count = 1,
            repeat_count = 14,
          ...
          {
            filename = "__TS_Power__/graphics/entity/petroleum-generator/hr-petroleum-generator-horizontal-anim.png",
            width = 448,
            height = 256,
            frame_count = 8,
            line_length = 4,
      ...
      vertical_animation =
      {
        layers = {
          {
            filename = "__TS_Power__/graphics/entity/petroleum-generator/hr-petroleum-generator-vertical-base.png",
            width = 256,
            height = 448,
            frame_count = 1,
            repeat_count = 8,
          ...
          {
            filename = "__TS_Power__/graphics/entity/petroleum-generator/hr-petroleum-generator-vertical-base-shadow.png",
            width = 256,
            height = 448,
            frame_count = 1,
            repeat_count = 8,
          ...
          {
            filename = "__TS_Power__/graphics/entity/petroleum-generator/hr-petroleum-generator-vertical-anim.png",
            width = 256,
            height = 448,
            frame_count = 8,
            line_length = 4,
      ...
      working_sound = {
        sound = {
          {
            filename = "__TS_Power__/sounds/diesel-loop-1.ogg",
            volume = 0.5
          },
          {
            filename = "__TS_Power__/sounds/diesel-loop-2.ogg",
            volume = 0.5
          },
          {
            filename = "__TS_Power__/sounds/diesel-loop-3.ogg",
            volume = 0.5
          }
        },
    ...
    },
    {
      ...
      results = {
        ...
        { type = "fluid", name = "uls-diesel-fuel", amount = 15, temperature = 25 }
      },
      main_product = "",
      icon = "__TS_Power__/graphics/icons/diesel-fuel-recipe-icon.png",
      icon_size = 64,
    ...
    },
    {
      ...
      results = {
        { type = "fluid", name = "diesel-fuel", amount = 15, temperature = 25 }
      },
      main_product = "",
      icon = "__TS_Power__/graphics/icons/diesel-fuel-recipe-icon.png",
      icon_size = 64,
    ...
    },
    {
      type = "technology",
      name = "petroleum-generator",
      icon = "__TS_Power__/graphics/technology/petroleum-generator-technology.png",
      icon_size = 256,
      effects = {
        {
          type = "unlock-recipe",
    ...
    },
    {
      ...
      icon = "__TS_Power__/graphics/icons/diesel-fuel-icon.png",
      icon_size = 64,
